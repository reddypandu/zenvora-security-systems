  ...
  return (
    <section id="about" className="section-padding relative overflow-hidden">
      ...
      <div className="container grid md-grid-cols-2 gap-16 items-center">
          ...
          <div className="absolute -bottom-8 -right-8 glass-morphism p-8 rounded-3xl z-20 shadow-2xl animate-fadeIn border-l-4 border-l-secondary">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-text-muted font-medium">Years of Trust</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <span className="section-subtitle text-left" style={{ textAlign: 'left' }}>The Zenvora Mission</span>
          <h2 className="section-title text-left mb-8 md-text-5xl" style={{ textAlign: 'left' }}>Redefining Safety through <span className="gradient-text">Innovation</span></h2>
          <p className="text-xl text-text-muted mb-10 leading-relaxed">
            At Zenvora Security Systems, we don't just install cameras; we build peace of mind. Our mission is to integrate AI and next-gen technology into daily safety, making premium security accessible to everyone.
          </p>
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-3 group">
                <div className="bg-secondary/10 p-1 rounded-full group-hover:bg-secondary transition-colors">
                  <CheckCircle2 className="text-secondary group-hover:text-white" size={18} />
                </div>
                <span className="text-base font-medium text-text-main/90">{item}</span>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 border-t border-white/10 pt-10">
            <div className="flex flex-col gap-2">
               ...
               <p className="text-sm text-text-muted">Dedicated support and installation engineers.</p>
            </div>
            <div className="flex flex-col gap-2">
               <div className="flex items-center gap-3 text-accent">
                 <Trophy size={24} />
               ...
               <p className="text-sm text-text-muted">Adhering to global quality and safety standards.</p>
            </div>
          </div>
        </motion.div>
      </div>
